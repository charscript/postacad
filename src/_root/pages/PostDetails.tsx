    ...
    <div className="post_details-container">
      {isPending ? <Loader /> : (
        <div className="post_details-card">
          {post && post?.imageUrl && post?.imageUrl !== 'https://example.com/default-image.jpg' && (
          ...
          <div className="post_details-info">
            ...
            <div className="flex flex-col flex-1 w-full small-medium lg:base-regular post-details-caption">
